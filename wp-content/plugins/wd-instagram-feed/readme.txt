...
*   Instagram account-based feed    
*   Instagram User meta data (image, bio, followers and posts number) display    
*   Thumbnail Layout Instagram feeds    
*   Image Browser Layout  Instagram feeds  
*   Sorting by options      
*   Load More and pagination options for Instagram feeds    
...
Upgrade to [Instagram Feed Pro](https://web-dorado.com/products/wordpress-instagram-feed-wd.html) to add features:      
...
*   HTML5 Video Support in Lightbox, Blog Style and Image Browser views for displaying Instagram videos   
...
After downloading the ZIP file of the Instagram Feed WD plugin,  
...
Since Thumbnails and Masonry Layout Instagram Feeds use identical set of properties we will discuss them jointly. When using  Thumbnail view Instagram images get identical dimensions, whereas with  Masonry view Instagram images and their properties (description, caption, hashtags) get displayed as a masonry feed.
...
= Lightbox Settings =
Note: Lightbox shows only already loaded images. For viewing entire Instagram Feed, you need to load all images included within the Instagram Feed.
